#--
# p3.py
# finds two closest documents using boolean term-document matrix and euclidean distance
...
# now we can use this to create a boolean term-document matrix
...
#     print
#     for j in range( len( DATA_FILES )):
#         print '%15s \t' % ( DATA_FILES[j] ),
#         for t in range( len( terms )):
#             print '%7d ' % ( termdoc[j][t] ),
#         print
